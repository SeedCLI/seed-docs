import { g as getDefaultExportFromCjs, r as reactExports, a as React2, t as toRscUrl, b as getPrefetchedUrls, s as storePrefetchResponse, R as React, u as useParams, c as useRouter$1, d as usePathname$1, e as reactDomExports, f as ReactDOM } from "../index.js";
...
const DefaultSearchDialog = reactExports.lazy(() => import("./search-default-4PlrDAxk.js").then((n2) => n2.s));
...
const Link$1 = reactExports.forwardRef(function Link2({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onNavigate, ...rest }, forwardedRef) {
  ...
  const linkStatusValue = React2.useMemo(() => ({ pending }), [pending]);
