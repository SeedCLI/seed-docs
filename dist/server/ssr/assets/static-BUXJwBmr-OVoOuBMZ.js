import { c as createContentHighlighter } from "./index-CAi4XXld.js";
import { r as removeUndefined } from "./remove-undefined-B_oBVupY-7355g_Rp.js";
import "./search-default-4PlrDAxk.js";
import "./worker-entry-CnPbAXF_.js";
import "../index.js";
...
function search$2(index, term, tokenizer, language, propertiesToSearch, exact, tolerance, boost, relevance, docsCount, whereFiltersIDs, threshold = 0) {
...
async function loadDB({ from = "/api/search", initOrama = (locale) => create({
  ...
  async function init() {
    ...
    if (data.type === "i18n") {
      await Promise.all(Object.entries(data.data).map(async ([k, v2]) => {
